...
ALTER TABLE USUARIOS
	ADD COLUMN IMG BLOB AFTER SENHA_USUARIO,
	ADD COLLUMNN ENUM('ativo', 'inativo', 'banido', 'pendente') DEFAULT 'pendente' AFTER IMG,
	ADD COLUMN DESCRICAO TEXT AFTER IMG,
...
MODIFY COLUMN TAMANHO ENUM('PP', 'P', 'M', 'G', 'GG', 'EGG', 'U');
...
CREATE TABLE INSTITUICAO_FINANCEIRA (
    ...
    CODIGO_INST VARCHAR(20),
    TIPO_CONTA ENUM('Corrente', 'Poupança', 'Pagamento'),
    DATA_CADASTRO DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE DENUNCIAS (
    ...
    ID_USUARIO INT NOT NULL,
    TIPO_ALVO ENUM('Produto', 'Brechó') NOT NULL,
...
CREATE TABLE CORREIOS (
    ID_CORREIO INT PRIMARY KEY AUTO_INCREMENT,
