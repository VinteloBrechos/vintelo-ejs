...
CREATE TABLE USUARIOS (
    ...
    IMG_URL VARCHAR(255),
    TIPO_USUARIO ENUM ('cliente', 'brecho', 'administrador') DEFAULT 'cliente',
...
CREATE TABLE PRODUTOS (
    ...
    STATUS_PRODUTO ENUM ('disponivel', 'indisponivel') DEFAULT 'disponivel',
    OUTROS TEXT,
...
CREATE TABLE PRODUTOS_CATEGORIAS (
    ...
    UNIQUE KEY unique_produto_categoria (ID_PRODUTO, ID_CATEGORIA_PRODUTO)
    FOREIGN KEY (ID_PRODUTO) REFERENCES PRODUTOS(ID_PRODUTO),
    FOREIGN KEY (ID_CATEGORIA_PRODUTO) REFERENCES CATEGORIAS_PRODUTOS(ID_CATEGORIA_PRODUTO)
);
